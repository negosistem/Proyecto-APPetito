...
# 1. Imports from our App
import sys
import os
# Force add backend path
sys.path.insert(0, r"C:\Users\sitem\OneDrive\Escritorio\Proyecto APPetito\Backend")
...
def run_migrations_offline() -> None:
    ...
    """
    # Overwrite URL with our settings
    context.configure(
        url=db_url,
